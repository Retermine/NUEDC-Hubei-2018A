...
#define SOURCE_SPI_FLASH_DEVICE_ID	XPAR_AXI_QUAD_SPI_0_DEVICE_ID
#define DESTINATION_DDR3_BASEADDR	XPAR_MIG_7SERIES_0_BASEADDR
...
#define REST_SECTION_BYTE_NUM		165712
